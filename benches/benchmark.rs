...
mod de {
    ...
    pub fn taxi_stands() -> Vec<TaxiStandRaw> {
    ...
    pub fn est_travel_time() -> Vec<EstTravelTimeRaw> {
        gen!(EstTravelTimeResp, _, "../dumped_data/est_travel_time.json")
    }

    pub fn crowd_density_rt() -> Vec<StationCrowdLevelRaw> {
        gen!(StationCrowdLevelRawResp, _, "../dumped_data/crowd_density_rt.json")
    }

    pub fn crowd_density_forecast() -> CrowdDensityForecastRaw {
